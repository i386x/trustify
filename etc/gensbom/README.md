...
The script will try to generate SBOM file in CycloneDX 1.6 JSON format for
...

{
  ...
  adding: quay.io-foo_bar-gensbom-test-v0.1.json (deflated 75%)
```
...
└── run-20250924-010705-OH7ty
    ├── sboms
    │   └── quay.io-foo_bar-gensbom-test-v0.1.json
    └── sboms.zip
